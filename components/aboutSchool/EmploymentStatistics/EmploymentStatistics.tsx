...
import EmploymentStatisticsType, { StatisticEntries, StatisticsSingleEntry } from '../types/EmploymentStatisticsType';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.entriesContainer}>
        {data.statistic_entry[currentSectionIndex].single_entry.map((item: StatisticsSingleEntry) => (
          <StatsEntry key={item.title} title={item.title} value={item.value}/>
        ))}
      </div>
    </div>
  );
