...
const SocialLinks = ({ facebook, instagram, youtube, isDark = false }: Props) => {
  return (
    <div className={styles.container}>
      <SocialLink social={instagram} image={isDark ? InstagramDarkIcon : InstagramIcon} />
      <SocialLink social={facebook} image={isDark ? FacebookDarkIcon : FacebookIcon} />
      <SocialLink social={youtube} image={isDark ? YoutubeDarkIcon : YoutubeIcon} />
    </div>
  );
};
